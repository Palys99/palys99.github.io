...
header('location:index.php');
	...
	if(isset($_POST['update']))
	{
		...
		$query=mysqli_query($con,"update users set billingAddress='$baddress',billingState='$bstate' where id='".$_SESSION['id']."'");
		if($query)
		{
echo "<script>alert('Dirección de entrega ha sido actualizada');</script>";
		}
	}
...
<html lang="es">
	<head>
	    ...
	    <title>ESCOMPRAS || Mi cuenta</title>
...
<div class="form-group">
					    <label class="info-title" for="Billing Address">Línea del metro<span>*</span></label>
					    <select class="form-control unicase-form-control text-input" name="billingaddress" required="required" value="<?php echo $row['billingAddress'];?>"> <option>Línea 1</option> <option>Línea 2</option> <option>Línea 3</option> <option>Línea 4</option> <option>Línea 5</option> <option>Línea 6</option> <option>Línea 7</option> <option>Línea 8</option> <option>Línea 9 <option>Línea A</option> <option>Línea B</option> <option>Línea 12</option></option></select>
					  </div>



						<div class="form-group">
					    <label class="info-title" for="Billing State ">Nombre de la estación de metro  <span>*</span></label>
