...
<html lang="es">
	<head>
	    ...
	    <title>ESCOMPRAS | Mi carro</title>
...
$_SESSION['pid']=$pdtid;
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Datos de entrega</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<a href="index.php" class="btn btn-upper btn-primary btn-block m-t-20">Seguir comprando</a>	</div>			</div>
		</div> 
		</form>
