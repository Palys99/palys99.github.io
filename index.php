...
if(isset($_GET['action']) && $_GET['action']=="add"){
	...
	if(isset($_SESSION['cart'][$id])){
		...
		if(mysqli_num_rows($query_p)!=0){
			...
			$message="El producto ID es inválido";
		}
	}
}
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Productos Destacados</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#books" data-toggle="tab">Playeras</a></li>
					<li><a href="#furniture" data-toggle="tab">Calzado</a></li>
					<li><a href="#" data-toggle="tab">Deportes</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Playeras</h3>
...
<iframe
    ...
    width="350"
    height="430"
    src="https://console.dialogflow.com/api-client/demo/embedded/7f73332b-2a01-4d21-ac98-3829c33d416f">
</iframe>

<df-messenger
  location="us-central1"
  project-id="tt-escom-399021"
  agent-id="440acd1a-b457-4303-9f1d-0ae3dfc72996"
  language-code="es">
  <df-messenger-chat-bubble
   chat-title="Chatbot TT">
  </df-messenger-chat-bubble>
</df-messenger>
<style>
  df-messenger {
...
<df-messenger
  intent="WELCOME"
  chat-title="CHATBOT_TT_ESCOM"
  agent-id="7f73332b-2a01-4d21-ac98-3829c33d416f"
  language-code="es"
></df-messenger>
