...
<html lang="es">
	<head>
	    ...
	    <title>ESCOMPRAS || Historial de Compras</title>
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="can-compra item">Cancelar orden</th>
				</tr>
			</thead><!-- /thead -->
...
?>
 ...
 <a href="javascript:void(0);" onClick="popUpWindow('track-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Track order">
					Seguimiento</td>
					<td class="cancelar-compra"> <a href="mailto:escompras@gmail.com?subject=Cancelación/Devolución pedido" name="cancelar_compra" /><font color="red">Cancelar pedido</font></td>
				</tr>
<?php $cnt=$cnt+1;} ?>
