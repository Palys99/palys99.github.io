...
<?php if(strlen($_SESSION['login']))
    {   ?>
				...
				<?php } ?>
					...
					<?php if(strlen($_SESSION['login']))
    {   ?>
				<li><a href="http://escompras.sytes.net/provider/"><i class="icon fa fa-user"></i>Subir producto</a></li>
				<?php } ?>
    ...
    {   ?>
<li><a href="loginclient.php"><i class="icon fa fa-sign-in"></i>Iniciar sesión</a></li>
<?php }
else{ ?>
