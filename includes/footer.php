...
<h3>Tienda Virtual TT</h3>
            </a>
        </div><!-- /.logo -->
   <!-- <img src="http://escompras.sytes.net/img/logo.jpg" alt="ESCOMPRAS" width="300" height="200">-->
    </div><!-- /.footer-logo -->

     <div class="module-body m-t-20">
        <p class="about-us"> TT, tienda virtual de artículos deportivos.</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(+52) 5527481554<br>(+52) 5517707896</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">tiendadeportiva@gmail.com</a></span>
                </div>
            </li>
